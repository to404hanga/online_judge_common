...
type Problem struct {
	...
	DescriptionURL string          `gorm:"column:description_url;type:varchar(255)" json:"description_url"`        // 题目 url
	TestcaseZipURL string          `gorm:"column:testcase_zip_url;type:varchar(255)" json:"testcase_zip_url"`      // 测试用例 zip 文件 url
