...
type Problem struct {
	...
	DescriptionHash string          `gorm:"column:description_hash;type:varchar(255);uniqueIndex:uk_description_hash" json:"description_hash"` // 题目描述哈希值
	TestcaseZipURL  string          `gorm:"column:testcase_zip_url;type:varchar(255);uniqueIndex:uk_testcase_zip_url" json:"testcase_zip_url"` // 测试用例 zip 文件 url
